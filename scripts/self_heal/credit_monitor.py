...
def _log_credit_failure(api: str, error: str, workflow: str = "credit_monitor.yml") -> None:
    ...
    try:
        ...
        # was permanently False and this refresh never ran — which is why every
        # Credit Blocks append from content_creator.yml returned HTTP 401
        # (runs 27463227130 on 6/13 and 28161948295 on 6/25). Refresh when we can.
