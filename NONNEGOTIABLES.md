...
_Last updated: 2026-07-30 (auto-updated by nonnegotiables_updater.py)_
...
- **CREATING CALENDAR EVENTS — try in order, never give up:** (from repo CLAUDE.md, 2026-05-15)
  ROUTE A: mcp__claude_ai_Google_Calendar__ tools (preferred) ROUTE B: Composio MCP — GOOGLECALENDAR_CREATE_EVENT action ROUTE C: Python OAuth — build('calendar','v3',credentials=creds).events().insert(


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-15)
  ROUTING BY PROJECT — always check which drive before creating anything: - Higashi / Hig Negócios / mom's site / Alexandra → Shared Drive "Higashi Imobiliária - Claude" (ID: 0AN7aea2IZzE0Uk9PVA) → Clau


- **EMAIL SENDING — 3 ROUTES (added 2026-04-12 — prevents "Gmail blocked" from stopp** (from repo CLAUDE.md, 2026-05-15)
  Gmail MCP = DRAFT only (no send tool exists). For actual sending, use GitHub Actions. - ROUTE A (draft): Load ToolSearch first → mcp__claude_ai_Gmail__gmail_create_draft → Priscila clicks Send - ROUTE


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-15)
  Any new automation, workflow, or script is NOT done until audited by the relevant AIOX agents: - /AIOX-architect — system design, API routing, architecture decisions - /AIOX-devops — GitHub Actions wo


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-15)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CREATING CALENDAR EVENTS — try in order, never give up:** (from repo CLAUDE.md, 2026-05-16)
  ROUTE A: mcp__claude_ai_Google_Calendar__ tools (preferred) ROUTE B: Composio MCP — GOOGLECALENDAR_CREATE_EVENT action ROUTE C: Python OAuth — build('calendar','v3',credentials=creds).events().insert(


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-16)
  ROUTING BY PROJECT — always check which drive before creating anything: - Higashi / Hig Negócios / mom's site / Alexandra → Shared Drive "Higashi Imobiliária - Claude" (ID: 0AN7aea2IZzE0Uk9PVA) → Clau


- **EMAIL SENDING — 3 ROUTES (added 2026-04-12 — prevents "Gmail blocked" from stopp** (from repo CLAUDE.md, 2026-05-16)
  Gmail MCP = DRAFT only (no send tool exists). For actual sending, use GitHub Actions. - ROUTE A (draft): Load ToolSearch first → mcp__claude_ai_Gmail__gmail_create_draft → Priscila clicks Send - ROUTE


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-16)
  Any new automation, workflow, or script is NOT done until audited by the relevant AIOX agents: - /AIOX-architect — system design, API routing, architecture decisions - /AIOX-devops — GitHub Actions wo


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-16)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CREATING CALENDAR EVENTS — try in order, never give up:** (from repo CLAUDE.md, 2026-05-17)
  ROUTE A: mcp__claude_ai_Google_Calendar__ tools (preferred) ROUTE B: Composio MCP — GOOGLECALENDAR_CREATE_EVENT action ROUTE C: Python OAuth — build('calendar','v3',credentials=creds).events().insert(


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-17)
  ROUTING BY PROJECT — always check which drive before creating anything: - Higashi / Hig Negócios / mom's site / Alexandra → Shared Drive "Higashi Imobiliária - Claude" (ID: 0AN7aea2IZzE0Uk9PVA) → Clau


- **EMAIL SENDING — 3 ROUTES (added 2026-04-12 — prevents "Gmail blocked" from stopp** (from repo CLAUDE.md, 2026-05-17)
  Gmail MCP = DRAFT only (no send tool exists). For actual sending, use GitHub Actions. - ROUTE A (draft): Load ToolSearch first → mcp__claude_ai_Gmail__gmail_create_draft → Priscila clicks Send - ROUTE


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-17)
  Any new automation, workflow, or script is NOT done until audited by the relevant AIOX agents: - /AIOX-architect — system design, API routing, architecture decisions - /AIOX-devops — GitHub Actions wo


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-17)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CREATING CALENDAR EVENTS — try in order, never give up:** (from repo CLAUDE.md, 2026-05-18)
  ROUTE A: mcp__claude_ai_Google_Calendar__ tools (preferred) ROUTE B: Composio MCP — GOOGLECALENDAR_CREATE_EVENT action ROUTE C: Python OAuth — build('calendar','v3',credentials=creds).events().insert(


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-18)
  ROUTING BY PROJECT — always check which drive before creating anything: - Higashi / Hig Negócios / mom's site / Alexandra → Shared Drive "Higashi Imobiliária - Claude" (ID: 0AN7aea2IZzE0Uk9PVA) → Clau


- **EMAIL SENDING — 3 ROUTES (added 2026-04-12 — prevents "Gmail blocked" from stopp** (from repo CLAUDE.md, 2026-05-18)
  Gmail MCP = DRAFT only (no send tool exists). For actual sending, use GitHub Actions. - ROUTE A (draft): Load ToolSearch first → mcp__claude_ai_Gmail__gmail_create_draft → Priscila clicks Send - ROUTE


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-18)
  Any new automation, workflow, or script is NOT done until audited by the relevant AIOX agents: - /AIOX-architect — system design, API routing, architecture decisions - /AIOX-devops — GitHub Actions wo
...
- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-20)
...
- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-20)
...
- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-20)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-20)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-20)
...
- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-20)
...
- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-20)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-20)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-21)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-21)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-21)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-21)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-21)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-21)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-21)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-21)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-22)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-22)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-22)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-22)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-22)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-22)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-22)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-22)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-23)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-23)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-23)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-23)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-23)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-23)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-23)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-23)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-24)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-24)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-24)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-24)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-24)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-24)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-24)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-24)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-25)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-25)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-25)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-25)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-25)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-25)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-25)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-25)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-26)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-26)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-26)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-26)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-26)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-26)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-26)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-26)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-27)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-27)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-27)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-27)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-27)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-27)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-27)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-27)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-28)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-28)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-28)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-28)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-28)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-28)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-28)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-28)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-29)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-29)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-29)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-29)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-29)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-29)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-29)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-29)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-30)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-30)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-30)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-30)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-30)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-30)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-30)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-30)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-05-31)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-05-31)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-05-31)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-05-31)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-05-31)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-05-31)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-05-31)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-05-31)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-01)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-01)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-01)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-01)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-01)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-01)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-01)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-01)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-02)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-02)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-02)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-02)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-02)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-02)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-02)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-02)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-03)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-03)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-03)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-03)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-03)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-03)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-03)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-03)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-04)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-04)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-04)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-04)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-04)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-04)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-04)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-04)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-05)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-05)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-05)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-05)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-05)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-05)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-05)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-05)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-06)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-06)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-06)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-06)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-06)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-06)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-06)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-06)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-07)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-07)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-07)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-07)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-07)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-07)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-07)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-07)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-08)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-08)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-08)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-08)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-08)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-08)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-08)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-08)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-09)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-09)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-09)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-09)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-09)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-09)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-09)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-09)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-10)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-10)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-10)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-10)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-10)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-10)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-10)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-10)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-11)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-11)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-11)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-11)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-11)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-11)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-11)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-11)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-12)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-12)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-12)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-12)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-12)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-12)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-12)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-12)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-13)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-13)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-13)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-13)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-13)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-13)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-13)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-13)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-14)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-14)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-14)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-14)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-14)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-14)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-14)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-14)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-15)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-15)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-15)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-15)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-15)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-15)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-15)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-15)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-16)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-16)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-16)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-16)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-16)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-16)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-16)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-16)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-17)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-17)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-17)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-17)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-17)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-17)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-17)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-17)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-18)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-18)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-18)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-18)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-18)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-18)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-18)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-18)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-19)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-19)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-19)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-19)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-19)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-19)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-19)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-19)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-20)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-20)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-20)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-20)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-20)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-20)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-20)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-20)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-21)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-21)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-21)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-21)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-21)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-21)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-21)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p
...
- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-23)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-23)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-23)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-23)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-23)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-23)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-23)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-23)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-24)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-24)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-24)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-24)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-24)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-24)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-24)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-24)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-25)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-25)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-25)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-25)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-25)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-25)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-25)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-25)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-26)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-26)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-26)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-26)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-26)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-26)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-26)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-26)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-27)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-27)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-27)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-27)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-27)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-27)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-27)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-27)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-28)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-28)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-28)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-28)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-28)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-28)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-28)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-28)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-29)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-29)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-29)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-29)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-29)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-29)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-29)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-29)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-06-30)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-06-30)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-06-30)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-06-30)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-06-30)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-06-30)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-06-30)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-06-30)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-01)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-01)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-01)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-01)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-01)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-01)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-01)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-01)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-02)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-02)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-02)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-02)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-02)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-02)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-02)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-02)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-03)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-03)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-03)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-03)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-03)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-03)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-03)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-03)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-04)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-04)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-04)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-04)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-04)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-04)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-04)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-04)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-05)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-05)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-05)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-05)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-05)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-05)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-05)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-05)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-06)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-06)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-06)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-06)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-06)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-06)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-06)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-06)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-07)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-07)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-07)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-07)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-07)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-07)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-07)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-07)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-08)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-08)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-08)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-08)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-08)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-08)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-08)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-08)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-09)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-09)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-09)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-09)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-09)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-09)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-09)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-09)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-10)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-10)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-10)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-10)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-10)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-10)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-10)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-10)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-11)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-11)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-11)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-11)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-11)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-11)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-11)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-11)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-12)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-12)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-12)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-12)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-12)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-12)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-12)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-12)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-13)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-13)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-13)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-13)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-13)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-13)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-13)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-13)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat


- **CONNECTIONS — always active, never ask for access** (from repo CLAUDE.md, 2026-07-14)
  RULE: Before saying "I don't have access," check `reference_active_connections.md` AND attempt the documented routes. Cloud OAuth / MCP first; Composio is fallback only. NEVER ask Priscila for credent


- **DRIVE — SHARED DRIVE IS DEFAULT, NEVER MY DRIVE** (from repo CLAUDE.md, 2026-07-14)
  ROUTING BY TOPIC — each topic has its own shared drive (source of truth) + a shortcut in a working cross-ref folder. Topics: Higashi · OPC · News · Stocks · Marketing · AI Content · UGC. RULES (stay g


- **⛔ DRIVE UPLOAD — BANNED METHODS (always creates empty files / fails silently)** (from repo CLAUDE.md, 2026-07-14)
  These methods are **banned** for uploading file bytes. They "succeed" but the file ends up empty. Every chat that has struggled with Drive uploads has been reaching for these: 1. ❌ `GOOGLEDRIVE_CREATE


- **NAMED-PERSON → FACE RULE, NON-NEGOTIABLE (added 2026-04-17)** (from repo CLAUDE.md, 2026-07-14)
  When content names a person (politician, business owner, accused, witness, victim, worker), their face MUST appear on that slide/frame. No exceptions. Pre-render checklist (run before exporting PNGs):


- **MOTION IS DEFAULT ON — see `/template-carousel` SKILL.md** (from repo CLAUDE.md, 2026-07-14)
  RULE (stays global, non-negotiable): every carousel build ships BOTH static PNGs AND motion (MP4 + GIF + preview frame + non-cover PNGs duplicated). Motion = default ON. Off ONLY when Priscila explici


- **AIOX AGENT AUDIT — REQUIRED BEFORE AUTOMATION IS "DONE"** (from repo CLAUDE.md, 2026-07-14)
  New automations (GitHub Actions workflows, Python scripts, integrations, routing logic) are NOT done until audited by `/AIOX-architect` → `/AIOX-devops` → `/AIOX-dev` in that order. Fix any flag befor


- **SCRIPT / CODE EDITING RULE — NON-NEGOTIABLE** (from repo CLAUDE.md, 2026-07-14)
  Never rewrite a working script from scratch. Only change what is strictly necessary. Before any edit: read the full file, list what you're changing and why. Good things already in the script must be p


- **CODE FIX AUDIT — NON-NEGOTIABLE (added 2026-05-05)** (from repo CLAUDE.md, 2026-07-14)
  Before committing ANY fix to validation, checking, or reviewer logic, run this checklist: 1. Trace BOTH execution paths — local build path (check_built_post / CONTENT_CREATOR_RUN) AND Drive/manual pat
